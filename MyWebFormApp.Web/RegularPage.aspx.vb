...
Public Class RegularPage
    ...
    Protected Sub btnBecomePremium_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnBecomePremium.Click
        Response.Redirect("ConfirmSubscription.aspx")
    End Sub
